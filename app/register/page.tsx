        ...
        <div className="bg-surface-container border border-primary/20 rounded-2xl p-8 shadow-[0_0_40px_rgba(255,45,120,0.1)]">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-secondary text-on-secondary font-bold font-label uppercase tracking-wider py-3 rounded-lg hover:shadow-[0_0_20px_rgba(0,255,204,0.5)] hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
              {loading ? (
